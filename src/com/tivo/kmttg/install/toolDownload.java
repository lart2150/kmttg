...
public class toolDownload {
   String windows_file = "http://kmttg.googlecode.com/files/kmttg_win32_tools_v0p7j.zip";
   String mac_file = "http://kmttg.googlecode.com/files/kmttg_MacOSX_tools_v0p7j.zip";
