...
public class remotecontrol {
   ...
   public remotecontrol (final Stage frame) {
      ...
      final Object[][] Buttons = {
         ...
         {"reverse",     "reverse.png",      0.5, 355,  55, 10, 0, "ShiftCOMMA",KeyCode.COMMA},
         {"replay",      "replay.png",       0.7, 355, 105, 10, 0, "Shift9",    KeyCode.DIGIT9},
         {"play",        "play.png",         0.7, 400,  10, 20, 0, "CLOSEB",    KeyCode.CLOSE_BRACKET},
         {"pause",       "pause.png",        0.4, 400,  50, 10, 0, "OPENB",     KeyCode.OPEN_BRACKET},
         {"slow",        "slow.png",         0.7, 400,  90, 20, 0, "ShiftBACK", KeyCode.BACK_SLASH},
         {"record",      "record.png",       0.7, 400, 130, 10, 0, "AltR",      KeyCode.R},
         {"thumbsUp",    "thumbsup.png",     0.7, 445,   0, 10, 0, "ADD",       KeyCode.ADD},
         {"forward",     "forward.png",      0.5, 445,  55, 10, 0, "ShiftPER",  KeyCode.PERIOD},
         {"advance",     "advance.png",      0.7, 445, 105, 10, 0, "Shift0",    KeyCode.DIGIT0},
      };
      ...
      Object[][] kb_shortcuts = new Object[][] {
         ...
         {"Shift;",    KeyCode.SEMICOLON,  true,  ":"},
         {"Shift-",    KeyCode.MINUS,      true,  "_"},
         {"COMMA",     KeyCode.COMMA,      true,  ","},
         {"PERIOD",    KeyCode.PERIOD,     true,  "."},
         {"SLASH",     KeyCode.SLASH,      true,  "/"},
         {"Shift'",    KeyCode.QUOTE,      true,  "\""},
